...
<div id="wrapper">
  ...
  <div id="page-body">
    ...
    <br>
    <span style="display: block;background-color: white;border-radius: 15px;border-style: solid;border-color: grey;border-width: 10px;color: black;overflow-x: hidden;overflow-y: hidden;max-height: 65px;text-align:center;">
      <form method="POST" action="">
